...
fn echange_count_1(){
    ...
    let mut flat_deck = DECK;
    let mut deck_mix = MixSet::new_from_flat(flat_deck);
    ...
    comb_vec.push(rank_number_to_card16(Rank::Queen.rank_number()));
    comb_vec.push(rank_number_to_card16(Rank::Jack.rank_number()));
    ...
    let (comb5_unfl_amount,comb5_fl_exist,comb5_fl_amount)  = exchange_comb_count(&fix_cards,&deck_mix,pyr_comb.pyr_bin);
    println!("******************************");
    println!("comb5_unfl_amount {}",comb5_unfl_amount);
    println!("comb5_fl_exist {}",comb5_fl_exist);
    println!("comb5_fl_amount {}",comb5_fl_amount);
